...
% compute (I - Pi) (G1_flux)
G_Flux = G1_Flux; % 1/2,...,N+1/2
G_Flux_proj = integration_v_meshgrid(G_Flux, dv) .* Psi; % projection -- sum over v
G_Flux_res = G_Flux - G_Flux_proj; % 1/2,...,N+1/2
